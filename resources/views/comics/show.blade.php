...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-around my-3">
            <a href="{{route('home')}}" class="btn btn-primary">Torna alla pagina proncipale</a>
            <a href="{{route('comics.edit',$comic->id)}}" class="btn btn-primary">Modifica campo</a>
            
            <form action="{{route('comics.destroy',$comic->id)}}" method="POST">
                @csrf
                @method('DELETE')
                <input type="submit" value="Cancella il prodotto" class="btn btn-primary">
